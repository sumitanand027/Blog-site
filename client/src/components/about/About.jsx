            ...
            <Box className={classes.wrapper}>
                ...
                <Typography variant="h5" className={classes.text}>I'm a Software Engineer based in India. 
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/sumitanand027" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Typography>
                <Typography variant="h5" className={classes.text}>
                    Need something built or simply want to have chat? Reach out to me on
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://www.linkedin.com/in/sumit-anand-285162190/" color="inherit" target="_blank">
                            <LinkedIn />
                        </Link>
                    </Box>  
                        or send me an Email 
                        <Link href="mailto:sumitanand027w@gmail.com?Subject=This is a subject" target="_blank" color="inherit">
                            <Email />
                        </Link>.
                </Typography>
            </Box>
